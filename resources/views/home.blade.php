...
@section('content')
    ...
    <div class="jumbotron">
        ...
        <div class="searchbox">
            <div class="container">
                <form class="form-group cf">
                    <div class="input-append">
                      <input class="span2 form-control" id="appendedInputButton" placeholder="Search" type="text">
    ...
    <div id="properties">
        ...
        @endforeach
        <a href="{{ route('hostel.index') }}">view all hostels</a>
        @endif
      </div>
      </div>
      <br>
      ...
      <div id="rooms" class="row clear-fix">
        ...
        @endforeach            
        <a href="{{ route('display.index') }}">view all rooms</a>
