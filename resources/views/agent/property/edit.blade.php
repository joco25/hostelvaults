...
<div class="container">
	...
	<div class="col-md-6 " >
		{!! Form::open(['method'=>'DELETE', 'action'=>['PropertyController@destroy',$property->id]]) !!}
		
	
		<div class="form-group">
			{!! Form::submit('Delete Property', ['class'=>'btn btn-danger col-sm-6 delete']) !!}
		</div>
	...
	{!! Form::model($property, ['method'=>'PATCH', 'action'=>['PropertyController@update',$property->id], 'files'=>true]) !!}
		...
		<div class="form-group">
			{!! Form::submit('Update Hostel', ['class'=>'btn btn-primary']) !!}
		</div>
