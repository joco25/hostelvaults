...
<div class="container" >
		...
		<div class="col-lg-12 col-md-12 col-sm-6">
            ...
            <div class="card hovercard" style=" margin-top: 2em;">
                <div class="cardheader" style="background-color: #3499DB; border-top: 3px solid #0665A2;">
                ...
                <div class="bottom">
                    <ul class="list-inline">
										  ...
										  <li><a href="#" class="btn btn-default">Reviews</a></li>
										  <li><a href="{{ route('room.edit',$user->room->id) }}" class="btn btn-default">Edit|Rent My Room</a></li>
										</ul>
                </div>
            </div>
          	...
          	<div class="col-md-4">
	          	...
	          	<div class="form-group">
	          		...
	          		{!! Form::label('age', 'Date of Birth:') !!}
						...
						<hr>
						<h4>Necessary Room information (Only fill if you intend to rent your room)</h4>
						<hr>
						<div class="row">
							<div class="col-md-4">
		          	<div class="form-group">
