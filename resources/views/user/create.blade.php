...
<div class="container">
	...
	{!! Form::open(['method'=>'POST', 'action'=>'RoomController@store', 'files'=>true]) !!}
		...
		<div class="form-group">
			...
			{!! Form::text('name', null, ['class'=>'form-control','placeholder'=>'John\'s room..']) !!}
		</div>

		<div class="form-group">
						{!! Form::label('description', 'Tell us about your Room:') !!}
						{!! Form::textarea('description', null, ['class'=>'form-control', 'rows'=>5,'placeholder'=>'Room description and direction to Room..']) !!}
		</div>
		...
		<div class="form-group">
				...
				{!! Form::text('location', null, ['class'=>'form-control','placeholder'=>'200000 (do not add any symbols or comma state the amount you would charge ur rommy)..']) !!}
			</div>

			<div class="form-group">
				{!! Form::label('school', 'School:') !!}
				{!! Form::text('school', null, ['class'=>'form-control','placeholder'=>'Okio odo']) !!}
			</div>
			...
			<div class="row">
				<div class="col-md-4">
						<div class="form-group">
							{!! Form::label('page', 'Age:') !!}
							{!! Form::text('page', null, ['class'=>'form-control','placeholder'=>'16-20']) !!}
						</div>
				</div>
				<div class="col-md-4">
						<div class="form-group">
